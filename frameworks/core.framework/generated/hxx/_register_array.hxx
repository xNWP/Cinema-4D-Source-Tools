...
namespace maxon
{
	...
	const maxon::Char* const ArrayFactory::MTable::_ids = 
		"NewBaseArray@1e292981003cc18f\0" // Result<ArrayInterface<Generic>*> NewBaseArray(const DataType& type, const Generic* src, Bool move)
		"NewBlockArray@1e292981003cc18f\0" // Result<ArrayInterface<Generic>*> NewBlockArray(const DataType& type, const Generic* src, Bool move)
	"";
	MAXON_WARNING_PUSH
