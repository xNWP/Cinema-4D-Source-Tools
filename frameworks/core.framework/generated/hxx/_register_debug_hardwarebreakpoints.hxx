...
namespace maxon
{
	...
	const maxon::Char* const DebugHardwareBreakPointInterface::MTable::_ids = 
		"Free@02ffa9ad9d24f912\0" // void Free(const DebugHardwareBreakPointInterface* object)
		"SetHardwareBreakpoint@bcc2d3ec6c4cae11\0" // Result<DebugHardwareBreakPointRef> SetHardwareBreakpoint(HARDWAREBREAKPOINTTYPE type, HARDWAREBREAKPOINTSIZE size, void* watchAddress)
		"RemoveHardwareBreakpoint@a54f4799cbe1a498\0" // Result<void> RemoveHardwareBreakpoint()
	"";
	MAXON_WARNING_PUSH
