...
namespace maxon
{
	...
	const maxon::Char* const FactoryInterface::MTable::_ids = 
		"PrivateGetDelegate@06662c384f80cd8e\0" // const DelegateBase* PrivateGetDelegate() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FactoryInterface, , "net.maxon.interface.factory", "maxon.FactoryInterface", (&DataDictionaryObjectInterface::_interface));
	const maxon::Char* const FactoryFactory::MTable::_ids = 
		"PrivateCreate@08519ee73dd39143\0" // Result<GenericFactory::NonConst> PrivateCreate(DelegateBase&& func, const DataDictionary& params)
		"PrivateCreateCached@34e751babf175464\0" // Result<GenericFactory::NonConst> PrivateCreateCached(DelegateBase&& func, DelegateBase&& creator, Int size, const DataDictionary& params)
		"CreateDataCached@7332637d4b2d9ec5\0" // Result<const Data&> CreateDataCached(const FactoryInterface* factory, const DataDictionary& params, DataCreator* dc)
	"";
	MAXON_WARNING_PUSH
