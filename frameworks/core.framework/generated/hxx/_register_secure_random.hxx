...
namespace maxon
{
	const maxon::Char* const SecureRandom::MTable::_ids = 
		"GetDefaultProvider@18f6dd3947eeb8eb\0" // SecureRandomProvider GetDefaultProvider()
		"GetRandomNumber@7c6c0fa81548ca7f\0" // Bool GetRandomNumber(SecureRandomProvider provider, const Block<Byte>& buffer)
	"";
	MAXON_WARNING_PUSH
	...
	maxon::Bool SecureRandom::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<SecureRandomProvider>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SecureRandom_GetDefaultProvider = &Hxx2::Wrapper<Hxx2::Unresolved>::_SecureRandom_GetDefaultProvider;
	#else
		tbl->_SecureRandom_GetDefaultProvider = &Hxx2::Wrapper<Hxx2::Unresolved>::_SecureRandom_GetDefaultProvider;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SecureRandom_GetRandomNumber = &Hxx2::Wrapper<Hxx2::Unresolved>::_SecureRandom_GetRandomNumber;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
