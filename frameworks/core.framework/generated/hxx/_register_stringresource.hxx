...
namespace maxon
{
	const maxon::Char* const LanguageInterface::MTable::_ids = 
		"Free@5c0d336b74006f2e\0" // void Free(const LanguageInterface* object)
		"Alloc@685eb92d48ebcf79\0" // LanguageInterface* Alloc(const maxon::SourceLocation& allocLocation)
		"LoadResourceString@19f1ca1db56084ad\0" // String LoadResourceString(const Id& scope, const InternedId& keyValue)
		"GetName@22c6ed80868\0" // String GetName() const
		"GetIdentifier@22aaf2\0" // Id GetIdentifier() const
		"GetFallbackLanguage@62404ffa164de7b2\0" // LanguageRef GetFallbackLanguage() const
		"ToString@e0aa3c58bc543cb4\0" // String ToString(const maxon::FormatStatement* fs) const
	"";
	MAXON_WARNING_PUSH
	...
	const maxon::Char* const Resource::MTable::_ids = 
		"GetDefaultLanguage@62404ffa164de79b\0" // LanguageRef GetDefaultLanguage()
		"GetCurrentLanguage@62404ffa164de79b\0" // LanguageRef GetCurrentLanguage()
		"FindLanguage@b7bf87b167eb895d\0" // LanguageRef FindLanguage(const Id& identifier)
		"SetCurrentLanguage@39bdfe18bf074e63\0" // Result<void> SetCurrentLanguage(const LanguageRef& language)
		"GetAllLanguages@140dfdd02956b008\0" // Result<BaseArray<LanguageRef>> GetAllLanguages()
		"LoadResourceString@24477998f6b01116\0" // String LoadResourceString(const Id& scope, const InternedId& keyValue)
		"ObservableLanguageChanged@94449cc5e219b96f\0" // maxon::ObservableRef<ObservableLanguageChangedDelegate> ObservableLanguageChanged()
	"";
	MAXON_WARNING_PUSH
	MAXON_WARNING_DISABLE_DEPRECATED
