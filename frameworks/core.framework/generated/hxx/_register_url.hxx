...
namespace maxon
{
	...
	const maxon::Char* const UrlInterface::MTable::_ids = 
		"Free@90ef223219100d4f\0" // void Free(const UrlInterface* object)
		"Alloc@1919cd4f0a0b4250\0" // UrlInterface* Alloc(const maxon::SourceLocation& allocLocation)
		"Alloc@2611b99399a4e51d\0" // UrlInterface* Alloc(const maxon::SourceLocation& allocLocation, const UrlInterface& object)
		"GetScheme@d40fa674ca538c66\0" // const UrlScheme& GetScheme() const
		"SetScheme@c5f32532e9182c47\0" // Result<void> SetScheme(const UrlScheme& scheme)
		"Append@84c7b902e2c48cc0\0" // Result<void> Append(const String& name)
		"Append@e1e93c17010d01ec\0" // Result<void> Append(const Url& relativeUrl)
		"RemoveName@a54f4799cbe1a498\0" // Result<void> RemoveName()
		"GetEmbeddedUrl@4e33a06\0" // Url GetEmbeddedUrl() const
		"SetEmbeddedUrl@e1e93c17010d01ec\0" // Result<void> SetEmbeddedUrl(const Url& url)
		"GetName@22c6ed80868\0" // String GetName() const
		"SetName@84c7b902e2c48cc0\0" // Result<void> SetName(const String& name)
		"GetDirectory@4e33a06\0" // Url GetDirectory() const
		"SetPath@84c7b902e2c48cc0\0" // Result<void> SetPath(const String& path)
		"GetPath@27f2c2db0d16c8cf\0" // const String& GetPath() const
		"SetSystemPath@84c7b902e2c48cc0\0" // Result<void> SetSystemPath(const String& path)
		"GetSystemPath@44dd277090c036a5\0" // Result<String> GetSystemPath() const
		"SetUrl@15108ee068612476\0" // Result<void> SetUrl(const String& urlString, Bool enableDefaultFallbackScheme)
		"GetUrl@22c6ed80868\0" // String GetUrl() const
		"SetAuthority@84c7b902e2c48cc0\0" // Result<void> SetAuthority(const String& authority)
		"SetAuthority@e1e93c17010d01ec\0" // Result<void> SetAuthority(const Url& authority)
		"GetAuthority@24368c97617cbacb\0" // const Url& GetAuthority() const
		"GetComponents@3bf6f91fd2075b33\0" // Result<void> GetComponents(const NonConstArray<String>& parts) const
		"GetRelativeUrl@80ddfa2d31821f51\0" // Result<Url> GetRelativeUrl(const Url& basePath) const
		"GetSuffix@22c6ed80868\0" // String GetSuffix() const
		"CheckSuffix@c49f0cd54ab1f37b\0" // Bool CheckSuffix(const String& suffix) const
		"SetSuffix@84c7b902e2c48cc0\0" // Result<void> SetSuffix(const String& suffix)
		"ClearSuffix@6b2e10f\0" // void ClearSuffix()
		"IsEmpty@76f01901\0" // Bool IsEmpty() const
		"Compare@28c48b040ae3999a\0" // COMPARERESULT Compare(const UrlInterface* name, URLCOMPARE mode) const
		"GetData@2eae62019803af60\0" // Result<Data> GetData(const ConstDataPtr& key) const
		"SetData@93fdde9367885994\0" // Result<void> SetData(ForwardingDataPtr&& key, const Data& data, Bool persistent)
		"SetData@e6575338e0a263af\0" // Result<void> SetData(ForwardingDataPtr&& key, Data&& data, Bool persistent)
