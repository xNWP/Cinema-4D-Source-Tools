...
namespace maxon
{
	...
	maxon::Bool ModuleVersionInfoInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ModuleVersionInfoInterface_RegisterIntern = &Hxx2::Wrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ModuleVersionInfoInterface_RegisterIntern;
	#else
		tbl->_ModuleVersionInfoInterface_RegisterIntern = &Hxx2::Wrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ModuleVersionInfoInterface_RegisterIntern;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ModuleVersionInfoInterface, , "net.maxon.interface.moduleversioninfo", "maxon.ModuleVersionInfoInterface", (&ObjectInterface::_interface));
	const maxon::Char* const ModuleVersionInfoInterface::Hxx2::StaticMTable::_ids = 
		"RegisterIntern@a8969be59e7438cd\0" // Result<void> RegisterIntern(const Id& uniqueId, const DataDictionary& moduleInfo, const ModuleInfo& info)
	"";
