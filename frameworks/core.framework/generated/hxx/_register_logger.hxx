...
namespace maxon
{
	...
	const maxon::Char* const LoggerTypeInterface::MTable::_ids = 
		"Write@dcf6278dbe7695c5\0" // Result<void> Write(const String& str, const SourceLocation& loc, WRITEMETA level)
		"Flush@a54f4799cbe1a498\0" // Result<void> Flush()
		"ObservableLoggerNotify@299eac2e68029e45\0" // maxon::ObservableRef<ObservableLoggerNotifyDelegate> ObservableLoggerNotify() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL(LoggerTypeInterface, LoggerTypeInterface, , , "net.maxon.interface.loggertype", "maxon.LoggerTypeInterface", (&ObserverObjectInterface::_interface), (&DataDictionaryObjectInterface::_interface), nullptr);
	const maxon::Char* const FileLoggerTypeInterface::MTable::_ids = 
		"Init@e1e93c17010d01ec\0" // Result<void> Init(const Url& url)
		"GetUrl@4e33a06\0" // Url GetUrl() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FileLoggerTypeInterface, , "net.maxon.interface.fileloggertype", "maxon.FileLoggerTypeInterface", (&LoggerTypeInterface::_interface));
	...
	const maxon::Char* const UserLoggerTypeInterface::MTable::_ids = 
		"Iterate@57c2f805f6e434ea\0" // Result<void> Iterate(const Delegate<Result<void>(LoggerLine&)>& callback)
		"GetCount@22da34\0" // Int GetCount()
		"Reset@6b2e10f\0" // void Reset()
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UserLoggerTypeInterface, , "net.maxon.interface.userloggertype", "maxon.UserLoggerTypeInterface", (&LoggerTypeInterface::_interface));
	const maxon::Char* const LoggerInterface::MTable::_ids = 
		"Free@f3ca273a1c75c6f6\0" // void Free(const LoggerInterface* object)
		"Alloc@668161349c9321b1\0" // LoggerInterface* Alloc(const maxon::SourceLocation& allocLocation)
		"AddLoggerType@7916a30626de8bef\0" // Result<void> AddLoggerType(TARGETAUDIENCE ta, const Class<LoggerTypeRef>& loggerTypeCls, const LOGGERTYPEINITCALLBACK& cb)
		"RemoveLoggerType@9fc2c011949b80b5\0" // Result<void> RemoveLoggerType(LoggerTypeRef& loggerType)
		"RemoveLoggerTypes@271bede43e89d598\0" // Result<void> RemoveLoggerTypes(const Class<LoggerTypeRef>& loggerTypeCls)
		"Write@a41c9c0e90c0bbdb\0" // Result<void> Write(TARGETAUDIENCE ta, const String& str, const maxon::SourceLocation& loc, WRITEMETA level)
		"GetName@22c6ed80868\0" // String GetName() const
		"SetName@0a91ca997ced89a9\0" // void SetName(const String& name)
		"Enable@5e65c14d7099\0" // void Enable(Bool enable)
		"IsEnabled@3d63259\0" // Bool IsEnabled()
		"GetLoggerTypes@6917f95f3938e17b\0" // BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>> GetLoggerTypes() const
		"ObservableLoggerNew@b8b54708db7808bb\0" // maxon::ObservableRef<ObservableLoggerNewDelegate> ObservableLoggerNew()
		"AddNewLogger@fed7cff1cc425b03\0" // Result<void> AddNewLogger(const Id& id, const LoggerRef& logger, const maxon::ModuleInfo* module)
	"";
	MAXON_WARNING_PUSH
