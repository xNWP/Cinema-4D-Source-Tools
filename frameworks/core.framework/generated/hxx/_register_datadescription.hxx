...
namespace maxon
{
	const maxon::Char* const DataDescriptionInterface::MTable::_ids = 
		"Free@25130b8900cb12ec\0" // void Free(const DataDescriptionInterface* object)
		"Alloc@1788cf55fba75bd3\0" // DataDescriptionInterface* Alloc(const maxon::SourceLocation& allocLocation)
		"Alloc@709c2536bb19193d\0" // DataDescriptionInterface* Alloc(const maxon::SourceLocation& allocLocation, const DataDescriptionInterface& object)
		...
		"GetEntries@2474341e113931aa\0" // Result<BaseArray<DataDictionary>> GetEntries() const
		"GetEntry@a270be6211772801\0" // Result<DataDictionary> GetEntry(const InternedId& id) const
		"SetEntry@a428cbd938c7a87b\0" // Result<Bool> SetEntry(const DataDictionary& props, Bool merge)
		"EraseEntry@f84e364681bdea85\0" // Result<void> EraseEntry(const InternedId& id)
		"Reset@6b2e10f\0" // void Reset()
		"IsEqual@fc7d5cd28f7ed521\0" // Bool IsEqual(const DataDescriptionInterface* other, EQUALITY equality) const
		"Compare@d15927ec95fd7135\0" // COMPARERESULT Compare(const DataDescriptionInterface* other) const
	...
	#else
		tbl->_DataDescriptionInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Alloc_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<DataDictionary>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_GetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetInfo;
	#else
		tbl->_DataDescriptionInterface_GetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetInfo;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_SetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_SetInfo;
	#else
		tbl->_DataDescriptionInterface_SetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_SetInfo;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_GetEntryCount = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetEntryCount;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<DataDictionary>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_GetEntries = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetEntries;
	#else
		tbl->_DataDescriptionInterface_GetEntries = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetEntries;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataDictionary>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetEntry;
	#else
		tbl->_DataDescriptionInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetEntry;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_SetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_SetEntry;
	#else
		tbl->_DataDescriptionInterface_SetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_SetEntry;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_EraseEntry;
	#else
		tbl->_DataDescriptionInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_EraseEntry;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Reset;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_IsEqual = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_IsEqual;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_Compare = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Compare;
	#else
		tbl->_DataDescriptionInterface_Compare = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_Compare;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_DataDescriptionInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetHashCode;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_ToString;
	#else
		tbl->_DataDescriptionInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_ToString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_DescribeIO;
	#else
		tbl->_DataDescriptionInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_DescribeIO;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_REGISTRY_REGISTER(LegacyIdentifiers);
