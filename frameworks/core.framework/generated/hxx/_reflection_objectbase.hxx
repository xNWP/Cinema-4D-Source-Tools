...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_Alloc)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "allocLocation\0cid\0kind\0", 21LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_AddComponent)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "component\0", 1LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_AddComponents)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "cls\0", 1LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_Create)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_IsSubclassOf)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "other\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_ToString)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "formatStatement\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_DeleteInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_DestructInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_CopyInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dest\0src\0", 6LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_GetOrCreateMTable)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "info\0i\0", 5LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_AddProxyComponent)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "component\0shared\0", 0LL, nullptr),
		};
...
/// @endcond
	...
	static maxon::InterfaceDefinition s_ObjectInterface(ObjectInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		String ToString(const FormatStatement* formatStatement) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_ToString_Offset), maxon::reflection::Argument::ByValue(formatStatement)};
			(*handler_)(_fn_ObjectInterface_ToString, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const FormatStatement*>::Invoke, (const void*) mt_._ObjectInterface_ToString));
			return proxy_result;
		}
		...
		Bool IsEqual(const maxon::ObjectInterface* other) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_IsEqual_Offset), maxon::reflection::Argument::ByValue(other)};
			(*handler_)(_fn_ObjectInterface_IsEqual, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const maxon::ObjectInterface*>::Invoke, (const void*) mt_._ObjectInterface_IsEqual));
			return proxy_result;
		}
		...
		COMPARERESULT Compare(const maxon::ObjectInterface* other) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_Compare_Offset), maxon::reflection::Argument::ByValue(other)};
			(*handler_)(_fn_ObjectInterface_Compare, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<COMPARERESULT, const maxon::GenericComponent*, const maxon::ObjectInterface*>::Invoke, (const void*) mt_._ObjectInterface_Compare));
			return proxy_result;
		}
		...
		UInt GetHashCodeImpl() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			UInt proxy_result = 0;
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_GetHashCodeImpl_Offset)};
			(*handler_)(_fn_ObjectInterface_GetHashCodeImpl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<UInt, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObjectInterface_GetHashCodeImpl));
			return proxy_result;
		}
...
/// @endcond
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ObjectInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_ObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "formatStatement\0", 1LL, ObjectInterface, _ObjectInterface_ToString),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "", 0LL, ObjectInterface, _ObjectInterface_InitObject),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "other\0", 1LL, ObjectInterface, _ObjectInterface_IsEqual),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "other\0", 1LL, ObjectInterface, _ObjectInterface_Compare),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObjectInterface, _ObjectInterface_GetHashCodeImpl),
/// @cond INTERNAL
...
/// @endcond
	...
	public:
		...
		const SourceLocation& GetLocation() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetLocation, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const SourceLocation&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_GetLocation));
			return *proxy_result;
		}
		...
		Block<void* const> GetStackTrace() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetStackTrace, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Block<void* const>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_GetStackTrace));
			return proxy_result;
		}
		...
		String GetMessage() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_GetMessage));
			return proxy_result;
		}
		...
		const Error& GetCause() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetCause, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Error&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_GetCause));
			return *proxy_result;
		}
		...
		Int PrivateGetCode() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateGetCode, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_PrivateGetCode));
			return proxy_result;
		}
		...
		void PrivateSetPreallocation(ThreadReferencedError preallocation) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ErrorInterface_PrivateSetPreallocation_Offset), maxon::reflection::Argument::ByValue(preallocation)};
			(*handler_)(_fn_ErrorInterface_PrivateSetPreallocation, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, ThreadReferencedError>::Invoke, (const void*) mt_._ErrorInterface_PrivateSetPreallocation));
		}
		...
		ThreadReferencedError PrivateGetPreallocation() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ErrorInterface_PrivateGetPreallocation_Offset)};
			(*handler_)(_fn_ErrorInterface_PrivateGetPreallocation, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ThreadReferencedError, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ErrorInterface_PrivateGetPreallocation));
			return proxy_result;
		}
		...
		void PrivateSetDebugError(const Error& cause) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ErrorInterface_PrivateSetDebugError_Offset), maxon::reflection::Argument::ByReference(cause)};
			(*handler_)(_fn_ErrorInterface_PrivateSetDebugError, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, const Error&>::Invoke, (const void*) mt_._ErrorInterface_PrivateSetDebugError));
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ErrorInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_ErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "allocLocation\0", 1LL, ErrorInterface, _ErrorInterface_SetLocation),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, _ErrorInterface_GetStackTrace),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "trace\0", 1LL, ErrorInterface, _ErrorInterface_SetStackTrace),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, _ErrorInterface_GetMessage),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "message\0", 1LL, ErrorInterface, _ErrorInterface_SetMessage),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, _ErrorInterface_GetCause),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "cause\0", 1LL, ErrorInterface, _ErrorInterface_SetCause),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "machine\0", 2LL, ErrorInterface, _ErrorInterface_GetMachine),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "machine\0", 1LL, ErrorInterface, _ErrorInterface_SetMachine),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, _ErrorInterface_PrivateGetCode),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "code\0", 0LL, ErrorInterface, _ErrorInterface_PrivateSetCode),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "preallocation\0", 0LL, ErrorInterface, _ErrorInterface_PrivateSetPreallocation),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, _ErrorInterface_PrivateGetPreallocation),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "cause\0", 0LL, ErrorInterface, _ErrorInterface_PrivateSetDebugError),
		};
