...
namespace maxon
{
	...
	{
		namespace enum348 { enum class TEXTENCODING
			{
		...
		maxon::String PrivateToString_TEXTENCODING348(std::underlying_type<enum348::TEXTENCODING>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum348::TEXTENCODING::NONE, (maxon::UInt64) enum348::TEXTENCODING::UTF8, (maxon::UInt64) enum348::TEXTENCODING::UTF16_BIGENDIAN, (maxon::UInt64) enum348::TEXTENCODING::UTF16_LITTLEENDIAN, (maxon::UInt64) enum348::TEXTENCODING::UTF32_BIGENDIAN, (maxon::UInt64) enum348::TEXTENCODING::UTF32_LITTLEENDIAN};
