...
namespace maxon
{
	const maxon::Char* const Configuration::MTable::_ids = 
		"QueryBool@ef8f9ea4628ac75d\0" // Bool QueryBool(const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state)
		"QueryInt@cb8ec20bda75b9b2\0" // Bool QueryInt(const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state)
		"QueryFloat@a920ecd3d34b1965\0" // Bool QueryFloat(const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state)
		"QueryString@af6e1b0e826ad996\0" // Bool QueryString(const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state)
