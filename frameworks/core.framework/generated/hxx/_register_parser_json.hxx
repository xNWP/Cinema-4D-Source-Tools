...
namespace maxon
{
	...
	const maxon::Char* const JsonParserInterface::MTable::_ids = 
		"Free@17562a1473b286ff\0" // void Free(const JsonParserInterface* object)
		"Alloc@f92856a34cadb001\0" // Interface* Alloc(const maxon::SourceLocation& allocLocation)
		"Write@25363bc62e81223c\0" // Result<void> Write(const DataDictionary& jsonObject, String& jsonString, Bool niceFormatting)
		"Read@bd4319e7b5d30fa0\0" // Result<void> Read(const String& jsonString, JSONPARSERFLAGS flags, const ValueReceiver<const DataDictionary&>& jsonObjects)
		"Read@2ea5d76d160f9b80\0" // Result<void> Read(UrlOrInputStream&& nameOrStream, JSONPARSERFLAGS flags, const StringDecodingRef& stringDecoding, const ValueReceiver<const DataDictionary&>& jsonObjects)
	"";
	MAXON_WARNING_PUSH
