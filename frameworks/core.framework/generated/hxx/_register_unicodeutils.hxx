...
namespace maxon
{
	...
	const maxon::Char* const UnicodeUtils::MTable::_ids = 
		"DecomposeStringHfs@fa6a9fe074ce2040\0" // Result<String> DecomposeStringHfs(const String& str)
		"DecomposeString@fa6a9fe074ce2040\0" // Result<String> DecomposeString(const String& str)
		"GetUnicodeVersion@22c6ed80851\0" // String GetUnicodeVersion()
		"NormalizeString@64764e37f48b4b8f\0" // Result<String> NormalizeString(NORMALIZATION form, const String& str)
		"UniCharDecomposition@7a1880ccc796ebd6\0" // Bool UniCharDecomposition(Utf32Char chr, DecompositionArray& res_decomp)
		"UniCharHfsDecomposition@a24e95fd960667a7\0" // Bool UniCharHfsDecomposition(Utf16Char chr, DecompositionHfsArray& res_decomp)
		"UniCodeCompare@e21cb774b450cad8\0" // COMPARERESULT UniCodeCompare(Utf32Char a, Utf32Char b)
		"UpperCase@9fd21dde8d1f254e\0" // Utf32Char UpperCase(Utf32Char chr)
		"TitleCase@9fd21dde8d1f254e\0" // Utf32Char TitleCase(Utf32Char chr)
		"LowerCase@9fd21dde8d1f254e\0" // Utf32Char LowerCase(Utf32Char chr)
	"";
	MAXON_WARNING_PUSH
	...
	maxon::Bool UnicodeUtils::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_DecomposeStringHfs = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_DecomposeStringHfs;
	#else
		tbl->_UnicodeUtils_DecomposeStringHfs = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_DecomposeStringHfs;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_DecomposeString = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_DecomposeString;
	#else
		tbl->_UnicodeUtils_DecomposeString = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_DecomposeString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_GetUnicodeVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_GetUnicodeVersion;
	#else
		tbl->_UnicodeUtils_GetUnicodeVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_GetUnicodeVersion;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_NormalizeString = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_NormalizeString;
	#else
		tbl->_UnicodeUtils_NormalizeString = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_NormalizeString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UnicodeUtils_UniCharDecomposition = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_UniCharDecomposition;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UnicodeUtils_UniCharHfsDecomposition = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_UniCharHfsDecomposition;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_UniCodeCompare = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_UniCodeCompare;
	#else
		tbl->_UnicodeUtils_UniCodeCompare = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_UniCodeCompare;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UnicodeUtils_UpperCase = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_UpperCase;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UnicodeUtils_TitleCase = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_TitleCase;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UnicodeUtils_LowerCase = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_LowerCase;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
