...
namespace maxon
{
	namespace enum56 { enum class MEMORYDIAGNOSTICSMODE : Int
		{
	...
	maxon::String PrivateToString_MEMORYDIAGNOSTICSMODE56(std::underlying_type<enum56::MEMORYDIAGNOSTICSMODE>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::ESTIMATEONLY, (maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::QUIET, (maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::VERBOSE, (maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::LEAKGRAPH, (maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::PRIVATE_OFF, (maxon::UInt64) enum56::MEMORYDIAGNOSTICSMODE::PRIVATE_ON};
	...
	namespace enum63 { enum class MEMORYOBSERVERMODE : Int
		{
	...
	maxon::String PrivateToString_MEMORYOBSERVERMODE63(std::underlying_type<enum63::MEMORYOBSERVERMODE>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum63::MEMORYOBSERVERMODE::LOWMEM_CLEANUP, (maxon::UInt64) enum63::MEMORYOBSERVERMODE::LOWMEM_FAILURE, (maxon::UInt64) enum63::MEMORYOBSERVERMODE::WARNMEM_LIMIT};
	...
	namespace enum70 { enum class SPECIALBEHAVIOR : Int
		{
			NONE											= 0,
	...
	maxon::String PrivateToString_SPECIALBEHAVIOR70(std::underlying_type<enum70::SPECIALBEHAVIOR>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum70::SPECIALBEHAVIOR::NONE, (maxon::UInt64) enum70::SPECIALBEHAVIOR::OMIT_HELP, (maxon::UInt64) enum70::SPECIALBEHAVIOR::DONTWARN_MISSINGARGUMENTS};
