...
#else
#endif
	namespace enum555 { enum class ENUM_DONT_INITIALIZE
	{
		VALUE
	} ; }
	maxon::String PrivateToString_ENUM_DONT_INITIALIZE555(std::underlying_type<enum555::ENUM_DONT_INITIALIZE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum555::ENUM_DONT_INITIALIZE::VALUE};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "ENUM_DONT_INITIALIZE", SIZEOF(x), false, values, "VALUE\0", fmt);
	}
	namespace enum565 { enum class IN_PLACE_TYPE
	{
		VALUE = 1
	} ; }
	maxon::String PrivateToString_IN_PLACE_TYPE565(std::underlying_type<enum565::IN_PLACE_TYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum565::IN_PLACE_TYPE::VALUE};
...
/// @cond INTERNAL
	...
	namespace enum1639 { enum class TYPE
		{
	...
	maxon::String PrivateToString_TYPE1639(std::underlying_type<enum1639::TYPE>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1639::TYPE::INVALID_0, (maxon::UInt64) enum1639::TYPE::INTERFACE, (maxon::UInt64) enum1639::TYPE::INTERFACE_NVMTABLE, (maxon::UInt64) enum1639::TYPE::NONVIRTUAL_INTERFACE, (maxon::UInt64) enum1639::TYPE::DECLARATION, (maxon::UInt64) enum1639::TYPE::COMPONENT, (maxon::UInt64) enum1639::TYPE::CLASS, (maxon::UInt64) enum1639::TYPE::TRANSLATION_UNIT, (maxon::UInt64) enum1639::TYPE::MODULE, (maxon::UInt64) enum1639::TYPE::INITIALIZATION, (maxon::UInt64) enum1639::TYPE::DEPENDENCY, (maxon::UInt64) enum1639::TYPE::REGISTRY, (maxon::UInt64) enum1639::TYPE::REGISTRY_MODULE, (maxon::UInt64) enum1639::TYPE::GLOBAL, (maxon::UInt64) enum1639::TYPE::COUNT};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "EntityBase::TYPE", SIZEOF(x), false, values, "INVALID_0\0INTERFACE\0INTERFACE_NVMTABLE\0NONVIRTUAL_INTERFACE\0DECLARATION\0COMPONENT\0CLASS\0TRANSLATION_UNIT\0MODULE\0INITIALIZATION\0DEPENDENCY\0REGISTRY\0REGISTRY_MODULE\0GLOBAL\0COUNT\0", fmt);
	}
	namespace enum1759 { enum class FLAGS : UInt32
		{
			NONE = 0,
	...
	maxon::String PrivateToString_FLAGS1759(std::underlying_type<enum1759::FLAGS>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1759::FLAGS::NONE, (maxon::UInt64) enum1759::FLAGS::CONSTRUCTED, (maxon::UInt64) enum1759::FLAGS::DISABLED, (maxon::UInt64) enum1759::FLAGS::INITIALIZED, (maxon::UInt64) enum1759::FLAGS::INITIALIZING, (maxon::UInt64) enum1759::FLAGS::INITIALIZATION_FAILED, (maxon::UInt64) enum1759::FLAGS::NULL_AS_DEFAULT, (maxon::UInt64) enum1759::FLAGS::USED, (maxon::UInt64) enum1759::FLAGS::HIDDEN, (maxon::UInt64) enum1759::FLAGS::REGISTRATION_UNIT, (maxon::UInt64) enum1759::FLAGS::DEFINITION, (maxon::UInt64) enum1759::FLAGS::SINGLE_BASE, (maxon::UInt64) enum1759::FLAGS::EXPLICIT, (maxon::UInt64) enum1759::FLAGS::FRAMEWORK, (maxon::UInt64) enum1759::FLAGS::CORE, (maxon::UInt64) enum1759::FLAGS::PROXY, (maxon::UInt64) enum1759::FLAGS::CLASS_PROXY, (maxon::UInt64) enum1759::FLAGS::FINAL, (maxon::UInt64) enum1759::FLAGS::SINGLE_IMPLEMENTATION, (maxon::UInt64) enum1759::FLAGS::MAIN_DEFINITION, (maxon::UInt64) enum1759::FLAGS::CALLABLE, (maxon::UInt64) enum1759::FLAGS::IMPLEMENTABLE, (maxon::UInt64) enum1759::FLAGS::ADAPTER, (maxon::UInt64) enum1759::FLAGS::SYNTHETIC, (maxon::UInt64) enum1759::FLAGS::LIVE, (maxon::UInt64) enum1759::FLAGS::EXPECT_FAILURE, (maxon::UInt64) enum1759::FLAGS::FRAMEWORK_REGISTRATION, (maxon::UInt64) enum1759::FLAGS::AT_REGISTRY_WITH_DEPENDENCIES, (maxon::UInt64) enum1759::FLAGS::PUBLIC, (maxon::UInt64) enum1759::FLAGS::REFERENCE_NONE, (maxon::UInt64) enum1759::FLAGS::REFERENCE_POINTER, (maxon::UInt64) enum1759::FLAGS::REFERENCE_CONST_POINTER, (maxon::UInt64) enum1759::FLAGS::REFERENCE_NORMAL, (maxon::UInt64) enum1759::FLAGS::REFERENCE_CONST, (maxon::UInt64) enum1759::FLAGS::REFERENCE_COPY_ON_WRITE, (maxon::UInt64) enum1759::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE, (maxon::UInt64) enum1759::FLAGS::REFERENCE_MASK, (maxon::UInt64) enum1759::FLAGS::ON_CONSTRUCTION_MASK};
...
/// @endcond
...
#ifdef USE_API_MAXON
#endif
	namespace enum2254 { enum class VALUEKIND : UInt64
	{
		NONE										= 0,
	...
	maxon::String PrivateToString_VALUEKIND2254(std::underlying_type<enum2254::VALUEKIND>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum2254::VALUEKIND::NONE, (maxon::UInt64) enum2254::VALUEKIND::VOID_TYPE, (maxon::UInt64) enum2254::VALUEKIND::GENERIC, (maxon::UInt64) enum2254::VALUEKIND::GENERIC_ARITHMETIC, (maxon::UInt64) enum2254::VALUEKIND::SCALAR, (maxon::UInt64) enum2254::VALUEKIND::INTEGRAL, (maxon::UInt64) enum2254::VALUEKIND::FLOATING_POINT, (maxon::UInt64) enum2254::VALUEKIND::ENUM, (maxon::UInt64) enum2254::VALUEKIND::ENUM_LIST, (maxon::UInt64) enum2254::VALUEKIND::ENUM_FLAGS, (maxon::UInt64) enum2254::VALUEKIND::DATA, (maxon::UInt64) enum2254::VALUEKIND::DATAPTR, (maxon::UInt64) enum2254::VALUEKIND::NONVIRTUAL_INTERFACE, (maxon::UInt64) enum2254::VALUEKIND::VIRTUAL_INTERFACE, (maxon::UInt64) enum2254::VALUEKIND::REF_OR_POINTER, (maxon::UInt64) enum2254::VALUEKIND::POINTER, (maxon::UInt64) enum2254::VALUEKIND::STRONG_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::COW_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::UNIQUE_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::ACOW_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::LV_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::RV_REFERENCE, (maxon::UInt64) enum2254::VALUEKIND::TUPLE, (maxon::UInt64) enum2254::VALUEKIND::NAMED_TUPLE, (maxon::UInt64) enum2254::VALUEKIND::STRUCT, (maxon::UInt64) enum2254::VALUEKIND::SIMD, (maxon::UInt64) enum2254::VALUEKIND::BLOCK, (maxon::UInt64) enum2254::VALUEKIND::STRIDED_BLOCK, (maxon::UInt64) enum2254::VALUEKIND::ARRAY, (maxon::UInt64) enum2254::VALUEKIND::BASEARRAY, (maxon::UInt64) enum2254::VALUEKIND::BLOCKARRAY, (maxon::UInt64) enum2254::VALUEKIND::RESULT, (maxon::UInt64) enum2254::VALUEKIND::DELEGATE, (maxon::UInt64) enum2254::VALUEKIND::FUNCTION, (maxon::UInt64) enum2254::VALUEKIND::CONST_QUALIFIED, (maxon::UInt64) enum2254::VALUEKIND::OPAQUE_QUALIFIED, (maxon::UInt64) enum2254::VALUEKIND::SOURCE_LEVEL, (maxon::UInt64) enum2254::VALUEKIND::DEEP_CONSTNESS, (maxon::UInt64) enum2254::VALUEKIND::INT_SIZE_OR_LESS, (maxon::UInt64) enum2254::VALUEKIND::ZERO_INITIALIZED, (maxon::UInt64) enum2254::VALUEKIND::ORDERED, (maxon::UInt64) enum2254::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE, (maxon::UInt64) enum2254::VALUEKIND::TRIVIALLY_DESTRUCTIBLE, (maxon::UInt64) enum2254::VALUEKIND::TRIVIALLY_COPYABLE, (maxon::UInt64) enum2254::VALUEKIND::TRIVIALLY_EQUATABLE, (maxon::UInt64) enum2254::VALUEKIND::OBJECT_REF, (maxon::UInt64) enum2254::VALUEKIND::VALUE, (maxon::UInt64) enum2254::VALUEKIND::ELEMENT_TYPE_AS_ARG, (maxon::UInt64) enum2254::VALUEKIND::NEVER_NULLPTR, (maxon::UInt64) enum2254::VALUEKIND::SIGNED, (maxon::UInt64) enum2254::VALUEKIND::CONTAINER, (maxon::UInt64) enum2254::VALUEKIND::STATIC_ARRAY_CONTAINER, (maxon::UInt64) enum2254::VALUEKIND::ARRAY_CONTAINER, (maxon::UInt64) enum2254::VALUEKIND::CONTAINER_REF, (maxon::UInt64) enum2254::VALUEKIND::GENERIC_CONTAINER, (maxon::UInt64) enum2254::VALUEKIND::COW_MASK, (maxon::UInt64) enum2254::VALUEKIND::STRONG_MASK, (maxon::UInt64) enum2254::VALUEKIND::PTR_MASK, (maxon::UInt64) enum2254::VALUEKIND::ARRAY_CONTAINER_MASK, (maxon::UInt64) enum2254::VALUEKIND::DERIVED_CONTAINER_MASK, (maxon::UInt64) enum2254::VALUEKIND::CONTAINER_MASK, (maxon::UInt64) enum2254::VALUEKIND::CONTAINER_OR_REF, (maxon::UInt64) enum2254::VALUEKIND::REFERENCE_MASK, (maxon::UInt64) enum2254::VALUEKIND::ARITHMETIC_MASK, (maxon::UInt64) enum2254::VALUEKIND::TUPLE_MASK, (maxon::UInt64) enum2254::VALUEKIND::TUPLE_INHERIT_MASK, (maxon::UInt64) enum2254::VALUEKIND::POINTER_FLAGS, (maxon::UInt64) enum2254::VALUEKIND::QUALIFIER_MASK};
	...
	namespace enum2300 { enum class COLLECTION_KIND
	{
	...
	maxon::String PrivateToString_COLLECTION_KIND2300(std::underlying_type<enum2300::COLLECTION_KIND>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum2300::COLLECTION_KIND::NONE, (maxon::UInt64) enum2300::COLLECTION_KIND::ARRAY, (maxon::UInt64) enum2300::COLLECTION_KIND::SET, (maxon::UInt64) enum2300::COLLECTION_KIND::MAP};
