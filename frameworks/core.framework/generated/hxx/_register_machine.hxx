...
namespace maxon
{
	...
	const maxon::Char* const MachineInterface::MTable::_ids = 
		"GetUniqueId@22c6ed80868\0" // String GetUniqueId() const
		"GetMachineInfo@073ad55d659a6f76\0" // Result<DataDictionary> GetMachineInfo() const
		"GetInterface@d343e8521a90cef4\0" // Result<ObjectRef> GetInterface(const Id& interfaceName)
		"GetState@cb534ffdf1fe7ea1\0" // MACHINESTATE GetState() const
		"SetState@d3b877e4563a7633\0" // Bool SetState(MACHINESTATE stateMask, MACHINESTATE stateFlags)
		"ToString@7de9f6f51c89c899\0" // String ToString(const FormatStatement* formatStatement) const
		"ObservableMessageReceived@0dbc1c699a555f3a\0" // maxon::ObservableRef<ObservableMessageReceivedDelegate> ObservableMessageReceived() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MachineInterface, , "net.maxon.interface.machine", "maxon.MachineInterface", (&ObserverObjectInterface::_interface));
...
/// @endcond
	...
	const maxon::Char* const MachinesInterface::MTable::_ids = 
		"GetLocal@1c4acbd0769f984c\0" // MachineRef GetLocal()
		"GetRPCMachines@82bb30d1287823ab\0" // Result<void> GetRPCMachines(WritableArrayInterface<MachineRef>& machines)
/// @cond INTERNAL

/// @endcond

		"FindRPCMachine@bc6fd548095a557b\0" // Result<MachineRef> FindRPCMachine(const String& machineUuid)
/// @cond INTERNAL

/// @endcond

		"FindOrAddRPCMachine@a2a810741d601e7c\0" // Result<MachineRef> FindOrAddRPCMachine(const String& machineUuid, MACHINESTATE state, const CreateNewMachineCallback& newMachineCallback, const CheckExistingMachineCallback& existingCallback)
/// @cond INTERNAL

/// @endcond

		"RemoveRPCMachine@12ba3487213a38de\0" // Result<void> RemoveRPCMachine(const MachineRef& machine)
		"ObservableMachineStateChanged@aaea1fc06a2de921\0" // maxon::ObservableRef<ObservableMachineStateChangedDelegate> ObservableMachineStateChanged()
	"";
	MAXON_WARNING_PUSH
