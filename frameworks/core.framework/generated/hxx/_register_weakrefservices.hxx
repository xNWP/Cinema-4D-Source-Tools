...
namespace maxon
{
	...
	const maxon::Char* const WeakRefServices::MTable::_ids = 
		"HasWeakReferences@b66a303b0f4a6203\0" // Bool HasWeakReferences(const void* target)
		"AddWeakReference@7c31309f224ab303\0" // Bool AddWeakReference(WeakRefBase& weakRef, const void* target)
		"RemoveWeakReference@83b8507ab5636c5a\0" // void RemoveWeakReference(WeakRefBase& weakRef)
		"MoveWeakReference@7dffaf62edf2e986\0" // void MoveWeakReference(WeakRefBase& dst, WeakRefBase& src)
		"CopyWeakReference@dd245808952ec313\0" // Bool CopyWeakReference(WeakRefBase& dst, const WeakRefBase& src)
		"ClearAllWeakReferences@b66a303b0f4a6203\0" // Bool ClearAllWeakReferences(const void* target)
		"TransferAllWeakReferences@f3108c6d608d9d36\0" // Bool TransferAllWeakReferences(const void* oldTarget, const void* newTarget)
		"AddObserver@1cad72fa82c5db6e\0" // Bool AddObserver(const void* target, MemoryObserverCallback callback, void* callbackData)
		"AddMetadata@0aa2deab213db67e\0" // Bool AddMetadata(const void* target, const Id* uniqueId, void* metadata, MemoryMetadataDestructor destruct)
		"EraseMetadata@bb8647017208cd5d\0" // Bool EraseMetadata(const void* target, const Id* uniqueId)
		"GetMetadata@0fab712779798509\0" // MemoryMetadataProxy GetMetadata(const void* target, const Id* uniqueId)
		"BrowseAllWeakReferences@e652399f1be320a3\0" // Result<Bool> BrowseAllWeakReferences(const void* oldTarget, const ValueReceiver<WeakRefBase*>& receiver)
	"";
	MAXON_WARNING_PUSH
