...
namespace maxon
{
	const maxon::Char* const Misc::MTable::_ids = 
		"SetFloatingPointChecks@68c0cdfee8fa0\0" // Bool SetFloatingPointChecks(Bool on)
	"";
	MAXON_WARNING_PUSH
	...
	#else
		tbl->_Misc_SetFloatingPointChecks = &Hxx2::Wrapper<Hxx2::Unresolved>::_Misc_SetFloatingPointChecks;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
