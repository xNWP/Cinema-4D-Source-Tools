...
namespace maxon
{
	...
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringEncodingInterface, , "net.maxon.interface.stringencoding", "maxon.StringEncodingInterface", (&StreamConversionInterface::_interface));
	const maxon::Char* const StringDecodingInterface::MTable::_ids = 
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringDecodingInterface, , "net.maxon.interface.stringdecoding", "maxon.StringDecodingInterface", (&StreamConversionInterface::_interface));
