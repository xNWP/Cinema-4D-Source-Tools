...
#define MAXON_UNIT_REGISTER_CHECK(NAME) static_assert(MAXON_TARGET_UNITY_MODE == 0, NAME " must not happen in unity builds. make sure you exclude the cpp file from the unity build.");
