...
template <typename T, GET_DATATYPE_POLICY POLICY> inline Result<DataType> CheckedGetDataType();
...
template <typename T> class PrivateGetDataTypeT
{
};
...
{
	iferr_scope;
	DataType t = (CheckedGetDataType<typename T::DirectlyReferencedType, (MAXON_IS_COW_KIND(T::Handler::KIND) ? POLICY & ~GET_DATATYPE_POLICY::NO_DECAY : POLICY | GET_DATATYPE_POLICY::NO_DECAY) | GET_DATATYPE_POLICY::ALLOW_BASEARRAY>()) iferr_return;
...
{
	return ParametricTypes::Pointer().GetPointer()->Instantiate(CheckedGetDataType<typename std::conditional<std::is_function<T>::value, Generic, T>::type, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}

template <GET_DATATYPE_POLICY POLICY, typename T> inline Result<DataType> PrivateGetDataType(Block<T>**, OverloadRank0)
{
	return ParametricTypes::Block().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}

template <GET_DATATYPE_POLICY POLICY, typename T> inline Result<DataType> PrivateGetDataType(StridedBlock<T>**, OverloadRank0)
{
	return ParametricTypes::StridedBlock().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}
...
{
	return ParametricTypes::Optional().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}

template <GET_DATATYPE_POLICY POLICY, typename T> inline Result<DataType> PrivateGetDataType(Result<T>**, OverloadRank0)
{
	return ParametricTypes::Result().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}

template <GET_DATATYPE_POLICY POLICY, typename T> inline Result<DataType> PrivateGetDataType(OpaquePtr<T>**, OverloadRank0)
{
	return ParametricTypes::Opaque().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>());
}
...
{
	return ParametricTypes::BaseArray().GetPointer()->Instantiate(CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY>::value>());
}
...
template <GET_DATATYPE_POLICY POLICY, typename... T> inline Result<TupleDataType> PrivateGetDataType(Tuple<T...>**, OverloadRank0)
{
	...
	Result<DataType> types[] = {CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>()...};
...
#endif
	Result<DataType> types[] = {CheckedGetDataType<ARGS, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>()..., {}};
...
#define PRIVATE_MAXON_DATATYPE_REGISTER(T, ret, flags) \
	...
	namespace \
	{ \
		static maxon::DataTypeImpl::Primary g_dataType_##T(DT_##T.GetId(), nullptr, nullptr, (T*) nullptr, (maxon::DataTypeFunctions<T>*) nullptr, flags); \
...
template <GET_DATATYPE_POLICY POLICY, typename T> inline typename std::enable_if<std::is_enum<T>::value, ResultOk<const DataType&>>::type PrivateGetDataType(T**, OverloadRank0)
{
...
template <typename T, GET_DATATYPE_POLICY POLICY> inline Result<DataType> CheckedGetDataType()
{
	...
	else if (Simd::value)
	{
		...
		t = ParametricTypes::Simd().Instantiate(t, {Simd::STRIDE, SIZEOF(typename Simd::type) / (Simd::STRIDE * SIZEOF(typename Simd::ValueType))}) iferr_return;
	}
	else
	{
...
template <typename T, GET_DATATYPE_POLICY POLICY> inline const DataType& GetDataType()
{
	...
	const Bool ELEMENTARY = std::is_fundamental<DT>::value || std::is_enum<DT>::value || std::is_same<DT, DataType>::value || std::is_pointer<decltype(PrivateDataTypeMarker((DT*) nullptr))>::value;
...
template <typename T> struct MemberTypeBase<T, typename std::enable_if<std::is_base_of<InternedId, T>::value, typename SFINAEHelper<void, typename T::ValueType>::type>::type>
{
	using OrigType = T;
...
template <typename T> struct MemberType : public MemberTypeBase<T>
{
	...
	{
		return Member(GetDataType<type, GET_DATATYPE_POLICY::NO_DECAY | GET_DATATYPE_POLICY::ALLOW_BASEARRAY>(), MemberTypeBase<T>::GetId());
	}
...
public:
	...
	static const ContainerDataType& GetContainerType()
	{
		...
		return _helper.members.containerType;
	}
...
private:
	...
	struct Helper
	{
		...
		Helper() : members{maxon::details::MemberType<T>::GetMember()...}
		{
		}
...
template <typename T> inline Result<void> Data::SetImpl(T&& data, OverloadRank0)
{
	...
	{
		return Functions::Set(ti.PrivateGetPointer(), &_memBlock, std::forward<T>(data));
	}
...
{
	DataType ti = checkDataType ? PrivateGetDataType<GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN>((T**) nullptr, OVERLOAD_MAX_RANK) iferr_ignore("Error correctly handled by nullptr.") : DataType::NullValue();
...
{
	iferr_scope;
	DataType t = CheckedGetDataType<T, Or<GET_DATATYPE_POLICY, POLICY, GET_DATATYPE_POLICY::NO_DECAY, GET_DATATYPE_POLICY::ALLOW_BASEARRAY>::value>() iferr_return;
