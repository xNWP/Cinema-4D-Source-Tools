...
htmlElements = set(['a', 'b', 'br', 'center', 'code', 'dl', 'dt', 'dd', 'em', 'hr', 'i', 'p', 'pre', 'span', 'strong', 'sub', 'sup', 'table', 'td', 'th', 'tr', 'tt', 'var'])
htmlEntities = set(['amp', 'apos', 'copy', 'deg', 'gt', 'larr', 'lt', 'nbsp', 'quot', 'rarr', 'reg', 'times', 'trade'])

doxSpecialChars = set(['"', '&', '%', '\\', '/', '<', '>', '@', '#', ',', '{', '}', '`'])
doxCommands = set(['@c', '@p', '@b', '@a', '@e', '@em', '@li', '@code', '@endcode', '@snippet', '@return', '@see', '@warning', '@note', '@attention', '@param', '@tparam', '@private', '@CLASS',
