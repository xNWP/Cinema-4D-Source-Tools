...
Bool CAWeightTag::TransferWeightMap(BaseDocument *doc, CAWeightTag *dst, Int32 sindex, Int32 dindex, Int32 offset, Int32 cnt, AliasTrans *trans, Bool mergeTags) { CALibCallR(false, weightTransferWeightMap)(this, doc, dst, sindex, dindex, offset, cnt, trans, mergeTags); }
...
maxon::Result<Int> CAWeightMgr::GetAutoWeightAlgoIndex(BaseDocument* doc, const maxon::Id& id) { CALibCallR(NOTOK, weightMgrGetAutoWeightAlgoIndex)(doc, id); }
maxon::Result<maxon::Id> CAWeightMgr::GetAutoWeightAlgoId(BaseDocument* doc, Int index) { CALibCallR(maxon::Id(), weightMgrGetAutoWeightAlgoId)(doc, index); }
maxon::Result<void> CAWeightMgr::GetAutoWeightRef(BaseDocument *doc, const maxon::Id& autoweightId, maxon::AutoWeightRef& autoWeightRef) { CALibCallR(maxon::UnexpectedError(MAXON_SOURCE_LOCATION, "unexpected error"_s), weightMgrGetAutoWeightRef)(doc, autoweightId, autoWeightRef); }
maxon::Result<maxon::DataDictionary> CAWeightMgr::GetAutoWeightDictionary(BaseDocument *doc, const maxon::Id& autoweightId)  {CALibCallR(maxon::DataDictionary(), weightMgrGetAutoWeightDictionary)(doc, autoweightId); }
maxon::Result<void> CAWeightMgr::SetAutoWeightDictionary(BaseDocument *doc, maxon::DataDictionary dataDictionary, maxon::Id autoweightId)  {CALibCallR(maxon::UnexpectedError(MAXON_SOURCE_LOCATION, "unexpected error"_s), weightMgrSetAutoWeightDictionary)(doc, dataDictionary, autoweightId); }
...
Bool CAWeightMgr::AutoWeight(BaseDocument* doc) { CALibCallR(false, weightMgrAutoWeight)(doc); }
