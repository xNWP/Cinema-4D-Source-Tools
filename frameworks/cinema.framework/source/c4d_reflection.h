...
#define REFLECTION_LAYER_NAME													0x0015			///< ::String Layer name.
// #define REFLECTION_LAYER_NOT_SELECTION_FLAGS					0x0016			///< ::Int32 Not selection layer flags.
// #define REFLECTION_LAYER_ID													0x0017			///< @markInternal ::Int32 Layer ID. (Do not change!)
#define REFLECTION_LAYER_MAIN_IMAGE_TRISTATE					0x0018			///< Image tristate group.
...
public:
	...
	/// @return												The layer ID. Must be a value greater or equal than 3, otherwise failure.
	//----------------------------------------------------------------------------------------
...
protected:
	Int32 _layerDataID;						///< @markInternal Used to retrieve layer data from material container. Note: this ID is dynamic and could vary (it's based on the layer position in the list)
