...
/// Class structure to hold HUD Text for @ref BaseDraw::DrawMultipleHudText
class HUDTextEntry
{
public:
...
#define DRAW_STATISTIC_PATCHES					6			///< ::Int32 Number of patches.
/// @}
...
/// @}
	...
	//----------------------------------------------------------------------------------------
	void DrawHUDText(Int32 x, Int32 y, const String &txt) { return C4DOS.Br->DrawHUDText(this, x, y, txt);  }

	//----------------------------------------------------------------------------------------
	/// Draw many HUD text entries at once.
	///
