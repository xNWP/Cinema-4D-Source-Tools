...
UpdateDialogHelper GeDialog::BeginLayoutChange(const GadgetPtr& gadget, Bool disableRedraws)
{
	return UpdateDialogHelper::BeginLayoutChange(this, gadget, disableRedraws);
}
...
UpdateDialogHelper UpdateDialogHelper::BeginLayoutChange(GeDialog* dialog, const GadgetPtr& gadget, Bool disableRedraws)
{
	UpdateDialogHelper obj = gadget.Id() ? UpdateDialogHelper(dialog, gadget.Id()) : UpdateDialogHelper(dialog, gadget.Ptr());

	if (dialog->LayoutFlushGroup(obj._gadget))
	{
		if (disableRedraws)
		{
