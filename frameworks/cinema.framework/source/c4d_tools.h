...
public:
	...
	/// @markPrivate
	//----------------------------------------------------------------------------------------
	Float CalcAmbientOcclusionEx(SurfaceIntersection* si, RaySampler* sampler, Float minlength, Float maxlength, Float index, Bool self, Bool trans, Float weight) { return C4DOS.Sh->CalcAmbientOcclusionEx(this, si, sampler, minlength, maxlength, index, self, trans, weight); }
...
enum BakeTexEnums
{
	...
	BAKE_TEX_NORMAL_USE_RAYCAST                     = 2136,     ///< Whether the normal map will be generated using ray casting.  True when baking the normal map only.
	...
	BAKE_TEX_RAYCAST_USE_MAX_DISTANCE									= 2443,   ///< ::Bool Use maximum ray casting distance.
	BAKE_TEX_RAYCAST_CUSTOM_MAX_DISTANCE							= 2444,   ///< ::Float Custom maximum ray casting distance.
	BAKE_TEX_RAYCAST_USE_AUTO_SPIKE_FILTER_THRESHOLD	=	2445,   ///< ::Bool Use automatic spike filter threshold.
	BAKE_TEX_RAYCAST_CUSTOM_SPIKE_FILTER_THRESHOLD		= 2446,		///< ::Float Custom spike filter threshold.
