...
enum
{
	...
	BFM_GETFOCUSBEFOREUPDATE					= 'bGFU',			///< A customgui receives this message before the layout is updated, used to avoid losing the focus over a specific gadget after the layout is updated. @see BFM_SETFOCUSAFTERUPDATE
																									/// @note These messages are only sent if the customgui is used inside the Attribute Manager and not when it's used in any other GeDialog.
																									/// @code
																									...
																									/// 	switch (msg.GetId())
																									/// 	{
																									/// 		case BFM_GETFOCUSBEFOREUPDATE: // Layout is about to update and '_activeGadgetId' could lose focus: store it
																									///				result.SetInt32(0, _activeGadgetId); // _activeGadgetId is a usual gadget id, e.g. AddButton(_activeGadgetId, BFH_LEFT, 0, 0 "My Button");
																									/// 			return true;
																									/// 			break;
																									///
																									/// 		case BFM_SETFOCUSAFTERUPDATE: // Layout has been updated (focus is in first gadget now): reactivate '_activeGadgetId'
																									///				_activeGadgetId = msg.GetInt32(0);
																									///				Activate(_activeGadgetId);
																									/// 			return true;
																									/// 			break;
																									///
																									/// 		...
																									...
																									/// }
																									/// @endcode
	BFM_SETFOCUSAFTERUPDATE						= 'bSFU',			///< A customgui description receives this message after the layout is updated, used to reactivate previously focused gadget. @see BFM_GETFOCUSBEFOREUPDATE
	...
	BFM_COLORCHOOSER_SYSTEM					= 1,			///< Not used anymore in new color chooser. Deprecated since R17.
	BFM_COLORCHOOSER_RGB_RANGE			= 2,			///< ::Int32 RGB range: @enumerateEnum{COLORSYSTEM_RANGE}
	BFM_COLORCHOOSER_H_RANGE				= 3,			///< Not used anymore in new color chooser. Deprecated since R17.
	BFM_COLORCHOOSER_SV_RANGE				= 4,			///< Not used anymore in new color chooser. Deprecated since R17.
	BFM_COLORCHOOSER_SYSTEMMESSAGE	= 5,			///< ::Bool Sends a parent message @ref BFM_COLORCHOOSER_PARENTMESSAGE if the settings change.
	BFM_COLORCHOOSER_QUICKSTORE			= 6,			///< Not used anymore in new color chooser. Deprecated since R17.
	BFM_COLORCHOOSER_MIXINGPANEL		= 7,			///< Not used anymore in new color chooser. Deprecated since R17.
