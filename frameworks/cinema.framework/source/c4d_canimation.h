...
public:
	...
	//----------------------------------------------------------------------------------------
	ROTATIONINTERPOLATION GetQuatInterpolation(void) const { return CaCall(GetQuatInterpolation) (); }
	//----------------------------------------------------------------------------------------
	...
	/// @param[in] bUndo							Add the three rotation keys in the undo system
	//----------------------------------------------------------------------------------------
	void SetQuatInterpolation(CCurve* seq, ROTATIONINTERPOLATION inter, Bool bUndo = true) { CaCall(SetQuatInterpolation) (seq, inter, bUndo, true); }
	/// @}
...
public:
	...
	/// @param[in] SynchronizeKeys		Since R17. routine is called on other components of the vector (if valid). Curve must be part of a Track.
...
public:
	...
	/// @{
	//----------------------------------------------------------------------------------------
	/// Return if keys are synchronized with other Component tracks (Vector Track Only)
	...
	/// @param[in] synch							Track need to be synchronized or not
	//----------------------------------------------------------------------------------------
