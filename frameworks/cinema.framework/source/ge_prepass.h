...
#define WPREF_MATMANAGER_DEFAULT_MATERIAL			1093			///< ::Int32 The default material that will be created when using command "New Default Material" or double click or Ctrl+N in Material Manager. @since R21
...
#define WPREF_MOUSE_TOUCHDEVICES					21084			///< ::Bool @since R20
...
#define DOCUMENT_GPURENDERER_STATISTICS	50000		///< BaseContainer within the document that stores the GPU statistics. @since R19
...
enum
{
	WPREF_COMMUNICATION_METRICS_DISABLE,									///< ::Bool. Enable/disable Metrics collection of information.
...
/// @addtogroup WPREF_GPURENDERER Preferences IDs
/// @ingroup group_containerid
/// @{
/// @since R19
enum
{
	...
	WPREF_GPURENDERER_METAL_AVAILABLE		 = 3000, // Since R19 SP3. Can be used to query if Metal is available for RPR
	WPREF_GPURENDERER_DEVICE_GPU_NAME		 = 4000,
	WPREF_GPURENDERER_DEVICE_GPU_COUNT   = 4050,
};
/// @}

/// @addtogroup DOCUMENT_GPURENDERER_STATISTICS IDs
/// @ingroup group_containerid
/// @{
/// @since R19
enum
