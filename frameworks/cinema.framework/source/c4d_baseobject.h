...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Return if Object Rotation is interpolated in Quaternion Mode.
	...
	//----------------------------------------------------------------------------------------
	/// Make sure that the track Curves component are synchronized (Keys on each component).
	...
	//----------------------------------------------------------------------------------------
	/// Try to find the best Euler Angle according to the previous key. The Object must have keys on each component
	...
	//----------------------------------------------------------------------------------------
	/// Force an evaluation of all rotation track and consider Quaternion interpolation.
	/// This will update attribute values if no vector is specified (resultRotation)
	/// @param[in] time								Evaluation time
	/// @param[in] flags							The animate flags: @enumerateEnum{@ref ANIMATEFLAGS}
	/// @param[in] resultRotation			Store result in Vector instead of updating attributes
	...
	//----------------------------------------------------------------------------------------
	/// Return each component track for the given DescID.\n
	/// @param[in] id									DescID of desired vector
	...
	/// @return												@trueIfOtherwiseFalse{DescID was valid}
	//----------------------------------------------------------------------------------------
	Bool GetVectorTracks(const DescID &id, CTrack *&xfound, CTrack *&yfound, CTrack *&zfound);
	//----------------------------------------------------------------------------------------
	/// Return each component CCurve for the given curve.\n
	...
	/// @return												@trueIfOtherwiseFalse{DescID for the curve was valid}
	//----------------------------------------------------------------------------------------
