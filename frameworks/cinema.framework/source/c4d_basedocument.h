...
/// Call FindPlugin() or FilterPluginList() with the plugin type @ref PLUGINTYPE_SCENEHOOK to retrieve scene hook instances. You can alternatively browse through all the plugin instances with GetFirstPlugin().
/// @see SceneHookData
//-------------------------------------------------------------------------------------------------
