...
#define MSG_REQUEST_NODE_SPACE_ADD								13246577		///< @markprivate @since R21 - sent to a BaseMaterial as a request for space creation.
#define MSG_REQUEST_NODE_SPACE_REMOVE							13246578		///< @markprivate @since R21 - sent to a BaseMaterial as a request for space removal.
