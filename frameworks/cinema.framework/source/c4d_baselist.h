...
/// @ingroup group_enumeration
/// @{
#define MSG_DESCRIPTION_INEX_DELETED							1036464				///< Sent by an InEx List to the parent. Tells the parent, that an entry got deleted from the list @correspondingData{DescriptionInExDeleted}
#define MSG_DESCRIPTION_INEX_ADDED								1036465				///< Sent by an InEx List to the parent. Tells the parent, that an entry got added to the list @correspondingData{DescriptionInExAdded}
#define MSG_DESCRIPTION_INEX_SELCHANGED						1037151				///< Sent by an InEx List to the parent. Tells the parent, that the selection in the InExclude List changed @correspondingData{DescriptionInExSelChanged}
...
#define MSG_DESCRIPTION_ALLOWOVERRIDE							431000094			///< Sent before the Take override is added to allow it or not. @correspondingData{DescriptionAllowOverride} @since R17.032 @see Take System @ref page_article_baseoverride_takesystem_additional_messages.
#define MSG_DESCRIPTION_TAKECHANGED								431000140			///< Sent to each overridden node when the user changes the current Take. Sent to both the node storing the data in the Take and the node releasing the data to the document. @correspondingData{DescriptionTakeChanged} @since R17.032 @see Take System @ref page_article_baseoverride_takesystem_additional_messages.
...
#define MSG_GETREALTAGDATA						1036447				///< Sent to get a real tag object from a virtual "generator" tag. @correspondingData{GetRealTagData}

#define MSG_DISABLE_SYMMETRY_OBJECTS	440000146			///< @markPrivate
#define MSG_ENABLE_SYMMETRY_OBJECTS		440000147			///< @markPrivate
#define MSG_SYMMETRY_FLIP 						431000173			///< @markPrivate
...
/// Message struct for the @ref MSG_GETREALTAGDATA message.
