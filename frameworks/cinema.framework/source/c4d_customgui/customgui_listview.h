...
/// @ingroup group_enumeration
/// @{
#define LV_COLUMN_WIDTH_AUTOMATIC		-1		///< Within GetColumnWidth return to Use automatic width for this column
#define LV_COLUMN_WIDTH_FIT					-2		///< Within GetColumnWidth return to use automatic fitting to available space for this column
/// @}
...
public:
	...
	void		SetFloatValue(TreeViewFunctions* pFuncs, void *root, void *userdata, void *obj, Int32 lColumn, Float value);
...
struct InternalFunctionTable
{
	...
	/*51*/ void			(TreeViewF::*SetFloatValue)(TreeViewFunctions* pFuncs, void *root, void *userdata, void *obj, Int32 lColumn, Float value);
