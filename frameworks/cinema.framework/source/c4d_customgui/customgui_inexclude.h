...
#define IN_EXCLUDE_FORBID_DOUBLECLICK			1036851 ///< ::Bool @markprivate Set to @formatConstant{true} in BaseList2D data container to ignore double click selection.
...
#define IN_EXCLUDE_FLAG_SMALL_MODE_SIZE		2067		///< ::Int32 Size of the InExclude list in small mode
#define IN_EXCLUDE_FLAG_BIG_MODE_SIZE		2068			///< ::Int32 Size of the InExclude list in big mode
...
public:
	...
	/// Sends @ref MSG_DESCRIPTION_INEX_ADDED to the parent
	...
	/// Sends @ref MSG_DESCRIPTION_INEX_DELETED to the parent
	...
	//----------------------------------------------------------------------------------------
	/// Gets the amount of flags for each object
	/// @return												the amount of flags for each object.
	//----------------------------------------------------------------------------------------
	Int32 GetFlagCount() const;

	//----------------------------------------------------------------------------------------
	/// Sets the flagCount for this InExclude List
	/// @param[in] lFlagCount					the amount of flags in this List
	//----------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------
	/// Gets the default flag for this list
	/// @param[in] defaultFlag				the default flag for new items to set
	//----------------------------------------------------------------------------------------
...
struct CustomGuiInExcludeLib : public BaseCustomGuiLib
{
	...
	Int32						(iIncludeExcludeData::*GetFlagCount)();
	Int32						(iIncludeExcludeData::*GetDefaultFlag)();
