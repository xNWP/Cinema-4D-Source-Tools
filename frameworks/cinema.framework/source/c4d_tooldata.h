...
struct ControlDisplayStruct
{
	...
	/// Constructor.
	//----------------------------------------------------------------------------------------
	ControlDisplayStruct() : displaymode(DISPLAYMODE_UNKNOWN), backface_culling(false), editmode(false), vertex_color(nullptr), dontfreevertexcolor(false), vertex_color_shading(false), perPolygonVertexColor(false) { }
	...
	Bool perPolygonVertexColor;				///< Each polygon vertex own a specific color.
};
