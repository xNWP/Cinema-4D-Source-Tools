...
#define ID_MODELING_KNIFE_LINE 														 	431000163			///< Knife line tool. See toolknifeline.h
																																					///< @note This tool cannot be used with SendModelingCommand().
#define ID_MODELING_KNIFE_PLANE															431000164			///< Knife Plane tool. See toolknifeplane.h
#define ID_MODELING_KNIFE_PATH 															431000165			///< Knife path/loop tool. See toolknifepath.h
