...
struct C4D_BaseDraw
{
	...
	void						(*DrawTexture1				)(BaseDraw *bd, C4DGLuint bmp, const Vector *padr4, const Vector *cadr, const Vector *vnadr, const Vector *uvadr, Int32 pntcnt, DRAW_ALPHA alphamode);
	...
	void						(*SetViewportRender		 )(BaseDraw *bd, const maxon::Id& id);
...
struct C4D_BaseView
{
	...
	Bool						(*VSPickObject1				)(BaseDraw* bd, BaseDocument* doc, Int32 x, Int32 y, Int32 rad, Int32 &xr, Int32 &yr, Int32 &wr, Int32 &hr, const ViewportPixel *const*&pixels, VIEWPORT_PICK_FLAGS flags, LassoSelection* ls, C4DObjectList* list, Matrix4d* m);
	Bool						(*VSPickObject2				)(BaseDraw* bd, BaseDocument* doc, Int32 x1, Int32 y1, Int32 x2, Int32 y2, Int32 &xr, Int32 &yr, Int32 &wr, Int32 &hr, const ViewportPixel *const*&pixels, VIEWPORT_PICK_FLAGS flags, LassoSelection* ls, C4DObjectList* list, Matrix4d* m);
...
struct C4D_General
{
	...
	maxon::Result<maxon::BaseArray<maxon::Tuple<maxon::Url, Bool>>>		(*GetGlobalTexturePaths)();
	...
	Bool						(*GetAllAssets									)(BaseDocument *doc, Bool allowDialogs, maxon::BaseArray<AssetEntry>& assets, Filename& lastPath, ASSETDATA_FLAG flags, NetRenderService* client);
