...
namespace enum830 { enum class MULTILINEEDITTEXTMESSAGEFLAGS
{
	NONE	= 0,						///< No flags.
	SET		= (1 << 0)			///< Set.
} ; }
maxon::String PrivateToString_MULTILINEEDITTEXTMESSAGEFLAGS830(std::underlying_type<enum830::MULTILINEEDITTEXTMESSAGEFLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum830::MULTILINEEDITTEXTMESSAGEFLAGS::NONE, (maxon::UInt64) enum830::MULTILINEEDITTEXTMESSAGEFLAGS::SET};
...
namespace enum1054 { enum class MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT
{
...
maxon::String PrivateToString_MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT1054(std::underlying_type<enum1054::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum1054::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::CANCEL, (maxon::UInt64) enum1054::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::MERGE, (maxon::UInt64) enum1054::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::NEWSCENE};
