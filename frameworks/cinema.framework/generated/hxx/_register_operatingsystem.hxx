#if 1
namespace enum784 { enum class VIEWPORTSELECTFLAGS
{
	NONE									= 0,			///< None.
...
maxon::String PrivateToString_VIEWPORTSELECTFLAGS784(std::underlying_type<enum784::VIEWPORTSELECTFLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::NONE, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::USE_HN, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::USE_DEFORMERS, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::REGION_SELECT, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::IGNORE_HIDDEN_SEL, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::USE_DISPLAY_MODE, (maxon::UInt64) enum784::VIEWPORTSELECTFLAGS::FORCE_USE_DEFORMERS};
...
namespace enum797 { enum class SCRIPTMODE
{
...
maxon::String PrivateToString_SCRIPTMODE797(std::underlying_type<enum797::SCRIPTMODE>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum797::SCRIPTMODE::NONE, (maxon::UInt64) enum797::SCRIPTMODE::PYTHON, (maxon::UInt64) enum797::SCRIPTMODE::AM_ID};
...
namespace enum811 { enum class BASEDRAW_HIGHLIGHT
{
...
maxon::String PrivateToString_BASEDRAW_HIGHLIGHT811(std::underlying_type<enum811::BASEDRAW_HIGHLIGHT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum811::BASEDRAW_HIGHLIGHT::BEFORE_TOOLS, (maxon::UInt64) enum811::BASEDRAW_HIGHLIGHT::AFTER_TOOLS, (maxon::UInt64) enum811::BASEDRAW_HIGHLIGHT::INVERSE_Z, (maxon::UInt64) enum811::BASEDRAW_HIGHLIGHT::DRAW_AFTER_CLEAR};
...
namespace enum826 { enum class FIELDLAYER_CHANNELFLAG
{
	NONE					= 0,						///< None.
...
maxon::String PrivateToString_FIELDLAYER_CHANNELFLAG826(std::underlying_type<enum826::FIELDLAYER_CHANNELFLAG>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::NONE, (maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::ENABLE, (maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::VALUE, (maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::COLOR, (maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::DIRECTION, (maxon::UInt64) enum826::FIELDLAYER_CHANNELFLAG::ROTATION};
...
namespace enum840 { enum class POPUPEDITTEXTCALLBACK
{
...
maxon::String PrivateToString_POPUPEDITTEXTCALLBACK840(std::underlying_type<enum840::POPUPEDITTEXTCALLBACK>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum840::POPUPEDITTEXTCALLBACK::TEXTCHANGED, (maxon::UInt64) enum840::POPUPEDITTEXTCALLBACK::CLOSED, (maxon::UInt64) enum840::POPUPEDITTEXTCALLBACK::CANCELED, (maxon::UInt64) enum840::POPUPEDITTEXTCALLBACK::CURSOR_UP, (maxon::UInt64) enum840::POPUPEDITTEXTCALLBACK::CURSOR_DOWN};
