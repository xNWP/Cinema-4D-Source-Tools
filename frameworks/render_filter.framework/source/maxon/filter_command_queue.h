#ifndef FILTER_COMMAND_QUEUE_INTERFACE_H__
#define FILTER_COMMAND_QUEUE_INTERFACE_H__
...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Enqueues Filter to the queue which will operate on a specific region of the image
	/// @param[in] filter			Filter to enqueue
	/// @param[in] input			Input Image to the filter
	/// @param[in] output			Output Image of the filter
...
#endif // FILTER_COMMAND_QUEUE_INTERFACE_H__
