...
namespace st
{
	...
	void st::iLog(const maxon::String& msg)
	{
		LoggerImpl::Write(msg);
	}

	void st::iLogError(const maxon::String& msg, const char* FILE, const char* FUNC, unsigned int LINE)
	{
	...
	void st::iLogErrorWhat(const maxon::String& WHAT, const char* FILE, const char* FUNC, unsigned int LINE)
	{
